...
export function basicInfoFormValidationsGenerator(T) {
    return {
        name: Yup.string()
            .min(3, T.translate("vehicle.form_validations.name.length", {len:3}))
            .required(T.translate("vehicle.form_validations.name.required"))
    };
}
    ...
    return (
        ...
        <div>
            <TextField
                ...
                required
                label={T.translate("vehicle.name")}
                autoFocus
                id="name"
                name="name"
                value={form.name}
            ...
            <TextField
                ...
                label={T.translate("vehicle.description")}
                type="text"
